      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <Sticker text='$199' className="block md:absolute mt-2 md:mt-0 md:top-0 md:right-[-150px] bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold shadow-lg transform md:rotate-[5deg] origin-top-right w-36 h-10 flex items-center justify-center text-sm mx-auto md:mx-0" />
            </div>
