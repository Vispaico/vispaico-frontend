      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <h3 className="text-3xl mt-4 text-gray-800">Perfect for consultants launching a practice, freelancers building credibility, or coaches needing a professional presence fast - 1 Day | $199</h3>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            <FounderNote>
              <p>
                &ldquo;I built this service because I know what &apos;client meeting in 12 hours&apos; panic feels like. Most agencies say &apos;sorry, we&apos;re booked.&apos; We don&apos;t do that.
              </p>
              <p>
                Here&apos;s why: Emergencies are where reputations are made or broken. You need someone who picks up the phone and says &apos;we&apos;ve got you.&apos; That&apos;s us.&rdquo;
              </p>
            </FounderNote>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faDesktop} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Built Your Way</h3><p className="text-gray-700">Perfect for showcasing your services, experience, and contact information across up to 5 focused pages.</p></motion.div>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-700">
              ...
              <h3 className="text-xl font-bold mt-8 text-black">How is this different from other agencies?</h3>
                  ...
                  <h3 className="text-xl font-bold mt-8 text-black">Ready in 24 hours for $199 - Everything Included</h3>
            </div>
          </motion.section>
