...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = '/images/BoandCon.webp',
  ...
  const [isMiniAvatarError, setIsMiniAvatarError] = useState(false);
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      const deviceMotionConstructor = window.DeviceMotionEvent as DeviceMotionEventConstructor | undefined;

      if (deviceMotionConstructor?.requestPermission) {
        deviceMotionConstructor
          .requestPermission()
  ...
  const resolvedMiniAvatarSrc = !miniAvatarUrl || isMiniAvatarError ? avatarUrl : miniAvatarUrl;
              ...
              <div className="pc-user-info">
                <div className="pc-user-details">
                  <div className="pc-mini-avatar">
                    <Image
                      src={resolvedMiniAvatarSrc}
                      alt={`${name || 'User'} mini avatar`}
                      width={48}
                      height={48}
                      className="pc-mini-avatar-img"
                      loading="lazy"
                      onError={() => setIsMiniAvatarError(true)}
