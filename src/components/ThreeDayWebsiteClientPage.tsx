      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <p className="text-1xl font-light mt-4 bg-clip-text bg-gradient-to-r text-white-300">3 Days | $899</p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-300">
              ...
              <p className="mt-2"><strong className="text-yellow-400">Ready in 3 Days for $899, all inclusive?</strong> - YES! 3 Days | $899</p>
            </div>
          </motion.section>
