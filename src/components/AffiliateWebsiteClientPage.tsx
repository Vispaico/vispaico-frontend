      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <h3 className="text-2xl mt-4 text-gray-800">A high-converting affiliate website with up to 6 product pages, ready to earn.</h3>  
            <p className="text-1xl font-light mt-4 bg-clip-text bg-gradient-to-r text-gray-700">2 Days | $399</p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <p className="mt-4 max-w-3xl mx-auto text-center text-gray-700">
              You want to start earning with affiliate marketing, but don&apos;t want to deal with the technical setup. We build your site, create up to 6 product pages, and hand you the keys—all in two days. <br/>We handle all the tech stuff so you can focus on your business.
            </p>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faWebAwesome} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Up to 6 Product Pages</h3><p className="text-gray-700">We create dedicated pages for up to 6 affiliate products with optimised content.</p></motion.div>
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faMobileAlt} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Mobile-First Design</h3><p className="text-gray-700">Looks perfect on all devices without breaking apart on any screen.</p></motion.div>
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faSearch} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">SEO & AiO Ready</h3><p className="text-gray-700">Built to be found on search engines like Google and  AI-Optimized Content for  AI summary search.</p></motion.div>
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faHandshake} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">You Provide the Idea</h3><p className="text-gray-700"> and the Links if you have them already. Otherwise we start from your idea and build the whole project to perfection for you.</p></motion.div>
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faClock} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Guaranteed 2-Day Delivery</h3><p className="text-gray-700">Your site will be live and ready to earn in 48 hours. And yes, that includes the hosting, the email setup, and the domain registration for 3 years if you need it.</p></motion.div>
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faRocket} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Ready to Launch</h3><p className="text-gray-700">And BAANG, just like that, no jargon, no hidden fees. Just a professional website, guaranteed.</p></motion.div>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-700">
              ...
              <h3 className="text-xl font-bold mt-8 text-black">How is this different from other agencies?</h3>
                  ...
                  <h3 className="text-xl font-bold mt-8 text-black">Ready in 2 Days for $399 - Everything Included</h3>
            </div>
          </motion.section>
          ...
          <motion.section className="mt-16 text-center" variants={itemVariants}>
            <div className="max-w-3xl mx-auto mt-8">
              ...
              <p className="text-1xl font-light mt-4 bg-clip-text bg-gradient-to-r text-gray-700">$399. 2 Days. Done.</p>
            </div>
          </motion.section>
        </div>
      </motion.div>
