...
function DiscountAppliedBanner() {
  ...
  const t = useTranslations('Services.TheBazooka');
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="border border-gray-300 rounded-lg p-6">
                <h2 className="text-xl font-bold text-center mb-4"><FontAwesomeIcon icon={faBomb} className="text-orange-500" /> {sections.whatsPossible.cardTitle}</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              {sections.launchPackage.cards.map((card, index) => {
                ...
                return (
                  ...
                  >
                    <FontAwesomeIcon
                      icon={iconMap[card.icon] ?? faBrain}
