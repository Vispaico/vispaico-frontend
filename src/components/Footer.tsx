...
const Footer: React.FC<FooterProps> = ({ siteTitle = "Vispaico" }) => {
    return (
        <footer className="bg-gray-50 text-slate-800 py-12 border-t border-gray-200">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    {/* Column 1: Logo and Mission */}
                    <div className="col-span-1 text-center md:text-left">
                        <div className="relative h-12 w-48 mx-auto md:mx-0 mb-4">
                            <Image src="/logos/vispaico burg logo.svg" alt="Vispaico Logo" fill style={{ objectFit: 'contain' }} />
                        </div>
                        <p className="text-slate-600 text-mb-4">The 3-Day Site <br /> $899 | Delivered in 3 Days.</p>
                    </div>
                    ...
                    <div className="col-span-1 text-center md:text-left">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/contact" className="text-slate-600 hover:text-indigo-600 transition-colors duration-300">Contact</Link></li>
                            <li><Link href="/faq" className="text-slate-600 hover:text-indigo-600 transition-colors duration-300">FAQ</Link></li>
                            <li><Link href="/about" className="text-slate-600 hover:text-indigo-600 transition-colors duration-300">About Us</Link></li>
                            <li><Link href="/terms" className="text-slate-600 hover:text-indigo-600 transition-colors duration-300">Terms</Link></li>
                            <li><Link href="/privacy" className="text-slate-600 hover:text-indigo-600 transition-colors duration-300">Privacy</Link></li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
                    <div className="flex space-x-4 mb-4 md:mb-0">
                        <a href="https://github.com/Vispaico" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-slate-500 hover:text-indigo-600 transition-colors duration-300">
                        ...
                        <a href="https://x.com/vispaico" target="_blank" rel="noopener noreferrer" aria-label="X (formerly Twitter)" className="text-slate-500 hover:text-indigo-600 transition-colors duration-300">
                        ...
                        <a href="https://www.linkedin.com/company/vispaico/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-slate-500 hover:text-indigo-600 transition-colors duration-300">
                        ...
                        <a href="https://www.facebook.com/vispaico/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-slate-500 hover:text-indigo-600 transition-colors duration-300">
                        ...
                        <a href="https://www.instagram.com/vispaico/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-slate-500 hover:text-indigo-600 transition-colors duration-300">
                    ...
                    <p className="text-center md:text-right">&copy; {new Date().getFullYear()} {siteTitle}. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
