      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <Sticker text='$3999' className="relative md:absolute mt-4 md:mt-0 md:top-0 md:right-[-150px] bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold shadow-lg transform rotate-0 md:rotate-[5deg] origin-top-right w-36 h-10 flex items-center justify-center text-sm" />
            </div>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-300">
              <h3 className="text-xl font-bold text-white">What is a multi product store?</h3>
