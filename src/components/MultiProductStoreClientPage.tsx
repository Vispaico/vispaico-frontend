...
function DiscountAppliedBanner() {
  ...
  const t = useTranslations('Services.FullOnlineStore');
      ...
      >
        <div className="container mx-auto px-4 py-16">
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <h3 className="text-2xl mt-4 text-gray-800">{hero.subtitle}</h3>
            <ul className="mt-12 space-y-4" role="list" aria-label="Key Benefits">
              {hero.bullets.map((bullet) => (
                <li key={bullet} className="text-2xl max-w-3xl mx-auto text-gray-600">
                  {bullet}
                </li>
              ))}
            </ul>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            <FounderNote>
              ...
              <p>
                ...
                <span className="text-orange-600">{founderNote.email}</span>
              </p>
            </FounderNote>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <h3 className="text-2xl text-center mt-4 text-gray-800">{sections.agencyTheater.subtitle}</h3>
            <div className="mt-8 text-lg max-w-2xl mx-auto space-y-2 text-gray-700">
              ...
              {sections.agencyTheater.pros.map((item) => (
                <p key={item} className="flex items-center font-semibold">
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-700 space-y-8">
              ...
              <h3 className="text-xl font-bold text-black">{sections.quickQuestions.closingTitle}</h3>
            </div>
          </motion.section>
