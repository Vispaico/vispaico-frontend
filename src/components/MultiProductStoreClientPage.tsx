        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faDesktop} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Your Choice of Format</h3><p className="text-gray-700">A fully functional e-commerce store.</p></motion.div>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-700">
              <h3 className="text-xl font-bold text-black">What is a multi product store?</h3>
              ...
              <p className="mt-2">All we need to start is your business/website name, your products, design ideas if you have any, and any text or product images you want to include. Even if you only have a few sentences, we can build from there.</p>
              ...
              <p className="mt-2"><strong className="text-orange-600">Ready in 10 Days for $3999, all inclusive?</strong> - YES! 10 Days | $3999</p>
            </div>
          </motion.section>
