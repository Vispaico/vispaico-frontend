      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <h3 className="text-2xl mt-4 text-gray-800">A complete web presence for your start-up.</h3>
            <p className="text-1xl font-light mt-4 bg-clip-text bg-gradient-to-r text-gray-700">15 Days | $6999</p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="border border-gray-300 rounded-lg p-6">
                <h2 className="text-xl font-bold text-center mb-4"><FontAwesomeIcon icon={faFire} className="text-orange-500" /> See What&apos;s Possible in 15 Days.</h2>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faDesktop} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Your Choice of Format</h3><p className="text-gray-700">A complete web presence for your start-up.</p></motion.div>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-700">
              <h3 className="text-xl font-bold text-black">What is a full-fledged start-up page?</h3>
              <p className="mt-2">A full-fledged start-up page is a complete web presence for your start-up. It includes everything you need to get your business online, including a website, blog, and e-commerce functionality.</p>
              ...
              <p className="mt-2"><strong className="text-orange-600">Ready in 15 Days for $6999, all inclusive?</strong> - YES! 15 Days | $6999</p>
            </div>
          </motion.section>

          {/* FINAL CTA SECTION */}
          <motion.section className="mt-16 text-center" variants={itemVariants}>
            <KickoffForm service="full-fledged-start-up-page" showServiceInfo={false} />
          </motion.section>
        </div>
      </motion.div>
    </>
