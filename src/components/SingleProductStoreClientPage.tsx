...
const SingleProductStoreClientPage = () => {
  ...
  const kickoffUrl = `/kickoff?service=single-product-store&discount=${discountAmount}`;
      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            <h1 className="text-5xl font-bold">Single Product Store.</h1>
            <h3 className="text-2xl mt-4 text-gray-300">A fully functional e-commerce store to sell your product.</h3>
            <p className="text-4xl font-bold mt-4 text-yellow-400">$1999 | Delivered in 3 Days</p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              ...
              <motion.div className="p-6 bg-gray-800 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faClock} className="text-4xl text-yellow-400 mb-4" /><h3 className="text-xl font-bold">Guaranteed 7-Day Delivery</h3><p className="text-gray-300">We mean it. You&apos;ll be ready to launch in 7 days.</p></motion.div>
          ...
          <motion.section className="mt-16 text-center" variants={itemVariants}>
            ...
            <Link href={kickoffUrl} passHref>
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
              >
                {Number(discountAmount) > 0 ? 'Start My Project & Apply Discount' : 'Start My Single Product Store'}
              </motion.button>
            </Link>
          </motion.section>
        </div>
