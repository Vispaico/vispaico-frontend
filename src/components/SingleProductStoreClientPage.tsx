// src/components/SingleProductStoreClientPage.tsx

'use client';

import { motion } from 'framer-motion';
import { useSearchParams } from 'next/navigation';
import SingleProductProcess from '@/components/SingleProductProcess';
...
const SingleProductStoreClientPage = () => {
      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-500 pb-2">Single Product Store.</h1>
            <h3 className="text-2xl mt-4 text-gray-300">A fully functional e-commerce store to sell your product.</h3>
            <p className="text-4xl font-bold mt-4 bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-500">$1999 | Delivered in 3 Days</p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="border border-gray-600 rounded-lg p-6">
                <h2 className="text-xl font-bold text-center mb-4">See What&apos;s Possible in 3 Days. <FontAwesomeIcon icon={faFire} className="text-orange-500" /> For $1999.</h2>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <p className="mt-4 max-w-3xl mx-auto text-center text-gray-300">
              That&apos;s why we offer one straightforward service: we take your basic info and turn it into a professional online presence in just 7 days. Whether you need a few pages to showcase your whole business or one powerful page to capture leads, the price and the promise are the same. We handle all the tech stuff so you can focus on your business.
            </p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-300">
              <h3 className="text-xl font-bold text-white">What is a single product store?</h3>
              <p className="mt-2">A single product store is a website that is dedicated to selling one product. It&apos;s a great way to focus your marketing efforts and drive sales.</p>
              <h3 className="text-xl font-bold mt-8 text-white">What information do you need from me?</h3>
              <p className="mt-2">All we need to start is your shop name, what is hhe product, and any text or product images you want to include. Even if you only have a few sentences, we can build from there.</p>
          ...
          <motion.section className="mt-16 text-center" variants={itemVariants}>
            <KickoffForm service="single-product-store" showServiceInfo={false} />
          </motion.section>
        </div>
      </motion.div>
    </>
...
export default SingleProductStoreClientPage;