...
const PremiumLandingPageClientPage = () => {
  ...
  const kickoffUrl = `/kickoff?service=premium-landingpage&discount=${discountAmount}`;
      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            <h1 className="text-5xl font-bold">Premium Landing Page.</h1>
            <h3 className="text-2xl mt-4 text-gray-300">A high-converting landing page to showcase your product or service.</h3>
            <p className="text-4xl font-bold mt-4 text-yellow-400">$699 | Delivered in 2 Days</p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <p className="mt-4 max-w-3xl mx-auto text-center text-gray-300">
              That&apos;s why we offer one straightforward service: we take your basic info and turn it into a professional online presence in just 5 days. Whether you need a few pages to showcase your whole business or one powerful page to capture leads, the price and the promise are the same. We handle all the tech stuff so you can focus on your business.
            </p>
          </motion.section>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              <motion.div className="p-6 bg-gray-800 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faDesktop} className="text-4xl text-yellow-400 mb-4" /><h3 className="text-xl font-bold">Your Choice of Format</h3><p className="text-gray-300">A high-impact single landing page.</p></motion.div>
              ...
              <motion.div className="p-6 bg-gray-800 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faClock} className="text-4xl text-yellow-400 mb-4" /><h3 className="text-xl font-bold">Guaranteed 5-Day Delivery</h3><p className="text-gray-300">We mean it. You&apos;ll be ready to launch in 5 days.</p></motion.div>
          ...
          <motion.section className="mt-16 text-center" variants={itemVariants}>
            ...
            <Link href={kickoffUrl} passHref>
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
              >
                {Number(discountAmount) > 0 ? 'Start My Project & Apply Discount' : 'Start My Premium Landing Page'}
              </motion.button>
            </Link>
          </motion.section>
        </div>
