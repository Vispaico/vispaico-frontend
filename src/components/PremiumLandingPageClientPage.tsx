      ...
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.section className="text-center" variants={itemVariants}>
            ...
            <h3 className="text-2xl mt-4 text-gray-800">A high-converting landing page to showcase your product, event or service.</h3>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8 text-center">
              <motion.div className="p-6 bg-gray-100 border border-gray-200 rounded-lg" variants={itemVariants}><FontAwesomeIcon icon={faDesktop} className="text-4xl text-indigo-700 mb-4" /><h3 className="text-xl font-bold">Your Choice of Format</h3><p className="text-gray-700">A high-impact single landing page.</p></motion.div>
          ...
          <motion.section className="mt-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto mt-8 text-gray-700">
              <h3 className="text-xl text-black">What is a premium landing page?</h3>
              ...
              <p className="mt-2"><strong className="text-orange-600">Ready in 2 Days for $499, all inclusive?</strong> - YES! 2 Days | $499</p>
            </div>
          </motion.section>
