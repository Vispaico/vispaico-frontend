...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    eyebrow: 'Vehicle Rental Marketplace',
    title: 'RiverCity Bike Rentals',
    headline: '40 qualified leads in month one. Built a partner marketplace that scales without hiring.',
    image: 'https://res.cloudinary.com/kinhcode01/image/upload/v1765178605/Vispaico/Images/rivercity_cover_qlxtcv.webp',
    alt: 'RiverCity Bike Rentals booking platform with vehicle marketplace and admin dashboard',
    stats: [
      { label: 'Leads Generated', value: '40/mo' },
      { label: 'Booking Growth', value: '2x' },
      { label: 'Response Time', value: '<60sec' },
    ],
    story:
      'RiverCity was choking on manual work: phone calls, WhatsApp inquiries, spreadsheet pricing, scattered owner payouts. We built a full-stack marketplace with smart booking intelligence, dynamic pricing that auto-calculates best rates, real-time availability across partner vehicles, and automated payouts. Vehicle owners can now submit and track earnings. The team publishes travel content that feeds the conversion funnel. Everything happens without leaving the platform.',
    results: [
      '5x increase in qualified inquiries month one (40 leads vs. 8 from phone/WhatsApp)',
      'Confirmed bookings doubled because customers self-serve instead of waiting for callbacks',
      'Partner marketplace live—vehicle owners can list, track payouts, set unavailability blocks automatically',
      'Team freed from call-handling to focus on concierge service and vehicle maintenance',
      'Response time dropped from 12+ hours to under 60 seconds via automated booking flow',
    ],
    techStack: ['React 18', 'Vite', 'Supabase', 'React Quill', 'Tailwind CSS', 'Radix UI', 'Framer Motion'],
    category: 'consultants',
    cta: { href: '/portfolio/rivercity-bike-rentals', label: 'Explore the Platform' },
    blogLink: { href: '/library/stories/how-to-scale-a-rental-business-with-automated-payouts', label: 'How we automated payouts' },
    servicesLinks: [
      { href: '/services#maintenance', label: 'Maintenance + Uptime' },
      { href: '/services#growth-content', label: 'Growth Content' },
    ],
