...
const ROUTE_SEGMENT = 'emergency-website-launches';
...
export default async function EmergencyWebsiteLaunchesStory({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const resolvedLocale = resolveLocale(locale);
  ...
  const articleMarkdown = String.raw`We say, "Send us your information."
