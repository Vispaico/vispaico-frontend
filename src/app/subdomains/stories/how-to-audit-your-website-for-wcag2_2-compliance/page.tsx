...
const story = storyLookup['how-to-audit-your-website-for-wcag2_2-compliance'];

if (!story) {
  throw new Error('Story data missing for how-to-audit-your-website-for-wcag2_2-compliance');
}
...
const articleMarkdown = String.raw`
### **What Does a Real Website Accessibility Audit Actually Look Like?**

If you think testing a website for accessibility just means running an automated tool, we've got news for you: that's maybe 30% of the work.
A proper audit is thorough, methodical, and involves multiple layers of testing.
...
export default function HowToAuditYourWebsiteForWcag22ComplianceStory() {
