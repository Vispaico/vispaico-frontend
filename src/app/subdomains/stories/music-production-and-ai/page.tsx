...
const story = storyLookup['music-production-and-ai'];

if (!story) {
  throw new Error('Story data missing for music-production-and-ai');
}
...
export default function MusicProductionAndAiStory() {
