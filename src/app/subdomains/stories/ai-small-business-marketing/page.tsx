...
const story = storyLookup['ai-small-business-marketing'];

if (!story) {
  throw new Error('Story data missing for ai-small-business-marketing');
}
...
const articleMarkdown = String.raw`AI is going to replace all marketers!

Or... AI is completely overhyped and useless!

The truth? Somewhere in between. And way more interesting than either extreme.

![](https://images.unsplash.com/photo-1614706465379-623e26271e54?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1974)
...
export default function AiSmallBusinessMarketingStory() {
      ...
      <div className="space-y-10 text-lg leading-relaxed text-slate-700">
        ...
        <section aria-labelledby="related-stories" className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-600">Get more playbooks for blending AI efficiency with human impact.</p>
          </div>
