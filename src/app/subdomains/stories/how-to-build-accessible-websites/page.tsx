...
const story = storyLookup['how-to-build-accessible-websites'];

if (!story) {
  throw new Error('Story data missing for how-to-build-accessible-websites');
}
...
const articleMarkdown = String.raw`### **Why Accessible Websites Aren't Optional Anymore**
...
![](https://images.unsplash.com/photo-1749744347474-0747641d8bf5?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=jpg&fit=crop&q=80&w=2070)

But here's the thing—accessibility isn't just about being nice. It's becoming a legal requirement. The EU Accessibility Act (EAA), the German Barrierefreiheitsstärkungsgesetz (BFSG), and compliance standards like WCAG 2.2 AA and EN 301 549 are now enforced. Non-compliance can mean hefty fines and legal exposure.
...
export default function HowToBuildAccessibleWebsitesStory() {
