...
import "./globals.css";
// import '@vispaico/agent-widget/styles/tokens.css'; — deactivated with SiteAgentWidget
...
// import { SiteAgentWidget } from "@/components/site-agent-widget"; — deactivated
  ...
  return (
    <html lang={locale}>
      ...
      <body className={`${inter.className} ...`}>
        ...
        {/* <SiteAgentWidget /> — deactivated, will be re-enabled later */}
      </body>
    </html>
  );
}