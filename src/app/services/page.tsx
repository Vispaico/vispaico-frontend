// src/app/services/page.tsx (Removed Unused Variables/Imports)
"use client";
...
// Removed unused imports: useCursor, Link
...
export default function ServicesPage() {
    ...
    // Removed unused variables: setIsHoveringInteractive, handleMouseEnter, handleMouseLeave
                            ...
                            return (
                                ...
                                <div key={service.id} id={service.slug} className="bg-gray-50 dark:bg-slate-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-slate-700 flex flex-col items-center text-center scroll-mt-20">
                                     ...
                                     {iconDef ? ( <div className="text-4xl text-indigo-500 dark:text-indigo-400 mb-4"><FontAwesomeIcon icon={iconDef} /></div> )
                                         : ( <div className="h-[40px] mb-4"></div> /* Placeholder space if no icon */ )}
                                     {/* Title */}
                                     ...
                                     {/* Keep 'Learn More' link commented out if no individual service pages yet */}
                                     {/* <Link href={`/service/${service.slug}`} className="mt-4 text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:underline" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>Learn More →</Link> */}
                                </div>
                            );
                        })}
                    </div>
